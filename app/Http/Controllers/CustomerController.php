...
class CustomerController extends Controller
{
    ...
    public function index()
    {
        ...
        /*         if ($user->hasPermission('purchase-order.viewAll')){
            $data = $this->employeeCodeRepository->all();
        }else{
            $data = $this->employeeCodeRepository->all()->where('company_code','=',$user->company_id);
        } */
