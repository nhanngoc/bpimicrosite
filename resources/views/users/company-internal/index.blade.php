...
@section('header')
    <div class="subheader">
        ...
        <div class="subheader-block d-lg-flex align-items-center">
            <a href="{!! route('company-internal.create') !!}" class="btn btn-xl btn-primary waves-effect">
                New {{ $title }}
            </a>
        </div>
    </div>
                    ...
                    @foreach($data as $item)
                        <tr index="{!! $item->id !!}">
                            ...
                            <td class="data-controls text-right">
                                <a href="{!! route('company-internal.edit',$item->id)!!}"
                                   class="data-edit btn btn-sm btn-icon btn-outline-danger rounded-circle mr-1"
                                   title="Edit">
                                    <i class="fal fa-pencil"></i>
                                </a>
                                <a href="{!! route('company-internal.destroy',$item->id)!!}"
